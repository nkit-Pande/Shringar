...
import { ArrowLeft, RefreshCcw, ShoppingCart, Star, TrendingUp, Truck } from "react-native-feather";
  ...
  <View style={styles.topBar}>
    ...
    <View style={{ flexDirection: "row" }}>
      ...
      <TouchableOpacity style={styles.otherButton} onPress={onPressWishlist}>
        <Heart height={25} width={25} stroke={"red"} fill={liked ? 'red':'none'}/>
      </TouchableOpacity>
    </View>
  </View>
);
...
export default function ItemDescription({ route, navigation }) {
  ...
  return (
    <SafeAreaView
      style={{ flex: 1, borderWidth: 1, borderColor: Colors.primary ,backgroundColor:'white'}}
    >
      <StatusBar
        animated={true}
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.productDetails}>
          ...
          <View style={styles.rating}>
            <Rating
              ...
              imageSize={15}
              showRating={false}
              style={{ backgroundColor: "transparent" }} // Add this style
            />
          ...
          <Text style={{
            ...
            color:"#A5A5A5"
          }}>{product.review_count} Reviews</Text>
          ...
          <View style={{flexDirection:'row',marginTop:13,alignItems:'center'}}>
            ...
            <View style={styles.weightContainer}>
              <Text style={styles.weightText}>{product.weight} Gram</Text></View>
          </View>
          <View style={{flexDirection:'row',marginTop:13,alignItems:'center'}}>
            <Text style={styles.weightHeader}>Gold Purity:</Text>
            <View style={styles.weightContainer}>
              <Text style={styles.weightText}>20 Karat</Text></View>
              {/* {product.carat} */}
          </View>
        ...
        <View>
          <View style={styles.guarantySection}>
            <TrendingUp stroke={Colors.dark} height={25} width={25} strokeWidth={3} style={styles.guarantyIcon}/>
        ...
        <View>
          <View style={styles.guarantySection}>
            <RefreshCcw stroke={Colors.dark} height={25} width={25} strokeWidth={3} style={styles.guarantyIcon}/>
            <Text style={styles.guarantyText}>
        ...
        <View>
          <View style={styles.guarantySection}>
            <Truck stroke={Colors.dark} height={25} width={25} strokeWidth={2.5} style={styles.guarantyIcon}/>
            <Text style={styles.guarantyText}>
